...
router.get('/products/:pid/:uid/:vid', viewController.addUserBid, viewController.settingsMyStuff);
router.get('/products/drop/:pid/:email/:uid', viewController.dropUserBid, viewController.settingsMyStuff);
